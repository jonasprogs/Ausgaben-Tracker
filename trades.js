...
(function(){
  ...
  function App(){
    ...
    function addTrade(){
      ...
      // wenn Datum nicht im aktuellen Monat → automatisch dorthin speichern/wechseln
    ...
    function updateTrade(id, patch){
      setItems(items().map(function(t){ return t.id===id ? Object.assign({}, t, patch) : t; }));
    }
      ...
      chartObj.current = new Chart(ctx, {
        ...
        options: {
          ...
          scales:{
            ...
            y:{ ticks:{ color:"#cbd5e1", callback:function(v){ return fmtEUR(v); } }, grid:{ color:"rgba(148,163,184,.15)" } }
          }
        }
      });
      return function(){ if(chartObj.current) chartObj.current.destroy(); };
    }, [month, list.length, total]);
    ...
    return h("div",{className:"w-container"},
      ...
      h("div",{className:"w-card"},
        ...
        h("div",{className:"w-grid-2", style:{marginBottom:"10px"}},
          ...
          h("div",{className:"w-row", style:{gap:"8px", flexWrap:"nowrap"}},
            h("input",{className:"w-input", type:"date", value:date, onChange:function(e){setDate(e.target.value);}}),
            h("select",{className:"w-select", value:type, onChange:function(e){setType(e.target.value);}},
              h("option",{value:"gain"},"Gewinn"),
              h("option",{value:"loss"},"Verlust")
            ),
            h("input",{className:"w-input", type:"number", step:"0.01", placeholder:"Betrag (€)", value:value, onChange:function(e){setValue(e.target.value);}}),
            h("button",{className:"w-button w-btn-primary", onClick:addTrade},"Hinzufügen")
          )
        ),
      ...
      // Chart
      h("div",{className:"w-card", style:{height:"280px"}},
        h("h3",null,"Gewinn/Verlust pro Tag"),
        h("div",{style:{position:"relative", height:"210px"}},
            ...
            h("tbody",null,
              list.map(function(t){
                ...
                return h("tr",{key:t.id},
                  ...
                  h("td",null,
                    h("span",{className:"t-badge "+(isGain?"gain":"loss"), style:{marginRight:"8px"}}, isGain? "Gewinn" : "Verlust"),
